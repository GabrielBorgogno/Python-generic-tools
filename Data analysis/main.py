...
figure.update_layout(title = "Deutsche Telekom AG Price Analysis", xaxis_rangeslider_visible=False)
figure.show()
figure = px.bar(data, x = "Date", y= "Close")
figure.show()
fgure = px.line(data, x='Date', y='Close', 
...
figure.show()
igure = px.scatter(data, x='Date', y='Close', range_x=['2021-07-12', '2022-07-11'],
